...
void detectAndDraw( Mat& img, CascadeClassifier& cascade,
	...
	{
		BoundingBox boundingbox=Observe::LoadBox(Observe::ObserveId+"bounding_boxs.box");
		...
		Observe::PtsLog(Observe::ObserveId+"demoResult.txt",current_shape);
		//cv::imshow( "result", img );
		Observe::SaveImg(Observe::ObserveId+"demoResult.jpg",img);
		return ;
	}
